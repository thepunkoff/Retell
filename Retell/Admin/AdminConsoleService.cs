...
public sealed class AdminConsoleService : BackgroundService
{
    ...
    private async Task Authorize(long userId, string password)
    {
        ...
        await _telegramBotClient.SendTextMessageAsync(userId, _configuration.Get<RetellConfig>().ToUserMarkdownString(), ParseMode.Markdown);
    }
            ...
            try
            {
                ...
                switch (split[0])
                {
                    ...
                    case "/status":
                        ...
                        await _telegramBotClient.SendTextMessageAsync(message.From.Id, _configuration.Get<RetellConfig>().ToUserMarkdownString(), ParseMode.Markdown, cancellationToken: stoppingToken);
                        break;
                    case "/login":
                        if (split.Length == 1)
                        {
                    ...
                    case "/signal":
                        ...
                        var cfg = _configuration.Get<RetellConfig>();
                    ...
                    case "/disable_signal_words":
                        ...
                        var cfg1 = _configuration.Get<RetellConfig>();
                    ...
                    case "/enable":
                        ...
                        var cfg2 = _configuration.Get<RetellConfig>();
                    ...
                    case "/disable":
                        ...
                        var cfg3 = _configuration.Get<RetellConfig>();
